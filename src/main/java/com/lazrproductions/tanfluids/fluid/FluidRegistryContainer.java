...
public class FluidRegistryContainer {
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = TanFluidsRegistry.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = TanFluidsRegistry.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = TanFluidsRegistry.FLUIDS.register(name + "_flowing",
        ...
        this.block = TanFluidsMod.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = TanFluidsMod.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
                                  ...
                                  BlockBehaviour.Properties blockProperties, Item.Properties itemProperties) {
        this.typeProperties = typeProperties.descriptionId("block.tanfludis."+name);
